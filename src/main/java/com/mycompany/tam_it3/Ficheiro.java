...
public class Ficheiro implements Serializable{
     ...
     * @return 
     */
    private static boolean gravarFicheiro(String nomeFicheiro, Agencia arr) {
        try
        {
 ...
 */
    ...
    public static boolean gravarInformacaoAgencia(String nomeFicheiro, Agencia arr) {
     ...
     * @return
     */
    public static Agencia lerInformacaoAgencia(String nomeFicheiro) {
